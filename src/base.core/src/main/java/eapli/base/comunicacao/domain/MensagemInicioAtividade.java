...
@Entity
public class MensagemInicioAtividade extends Mensagem {

    public MensagemInicioAtividade() {
    }

    public MensagemInicioAtividade(String idMaquina, Timestamp dataHora, String idOrdemProducao) {
